<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\www\tp5\public/../application/user/view/default/login\index.html";i:1533788368;s:67:"D:\www\tp5\public/../application/user/view/default/base\common.html";i:1533786527;s:64:"D:\www\tp5\public/../application/user/view/default/base\var.html";i:1496373782;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
...
<section>
  <div class="container-fluid">
    <form action="" method="post">
      ...
      <div class="form-group">
        <label>验证码</label>
        <input type="text" class="form-control" placeholder="请输入验证码" errormsg="请填写5位验证码" nullmsg="请填写验证码" datatype="*5-5" name="verify"/>
      </div>
      ...
      <div class="control-group">
        <div class="controls">
          ...
          <button class="btn btn-primary onlineBtn" type="submit">登录</button>
        </div>
      </div>
    </form>

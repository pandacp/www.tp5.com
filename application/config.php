...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '>Vh*/5S3R0cZn}`b|{q,9Of7NatvGMBF~JdoEk%1', //默认数据加密KEY
	'data_cache_key'=> '>Vh*/5S3R0cZn}`b|{q,9Of7NatvGMBF~JdoEk%1',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'>Vh*/5S3R0cZn}`b|{q,9Of7NatvGMBF~JdoEk%1', //加密KEY
